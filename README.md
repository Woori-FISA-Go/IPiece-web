...
- [2. 팀원 및 역할](#2-팀원-및-역할)
- [3. 주요 기능](#3-주요-기능)
- [4. 기술 스택 및 선정 이유](#4-기술-스택-및-선정-이유)
...
| **⚡ Real-time** | ![Socket.io](https://img.shields.io/badge/Socket.io-010101?style=flat&logo=socket.io&logoColor=white) | 실시간 호가창, 차트 데이터 등 양방향 통신이 필요한 기능에 사용되며, 자동 재연결을 지원하여 안정적입니다. |
...
│   ├── lib/                   # 유틸리티 함수 (cn, utils 등)
│   ├── stores/                # Zustand 스토어 (authStore, uiStore 등)
